...
const StepPriceComponent = ({ actions, data }: Props) => {
  ...
  const { unitPrice, salePrice, product } = data;
      ...
      <Paper elevation={2} sx={{ p: 4, borderRadius: 2 }}>
        ...
        <Stack spacing={3}>
          <TextField
            ...
            defaultValue={
              convertFromCents(product?.unitPrice || 0) || unitPrice
            }
          />
          ...
          <TextField
            ...
            defaultValue={
              convertFromCents(product?.salePrice || 0) || salePrice
            }
          />
          ...
          >
            ...
            <Button
              ...
              sx={{ minWidth: 120 }}
            >
              {product?._id ? "Concluir Alteração" : "Concluir Cadastro"}
            </Button>
          </Box>
        </Stack>
      </Paper>
...
export const StepPrice = ({ data }: StepPriceProps) => {
  const { product } = data;
